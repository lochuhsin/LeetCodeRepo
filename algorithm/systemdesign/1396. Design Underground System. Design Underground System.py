'''
This solution thought has comeup in my mind before,
however i'm not able to think deep enough or be very familier
enough to code system design like problems.

Study this one carefully. (Using two hashtable)
'''
